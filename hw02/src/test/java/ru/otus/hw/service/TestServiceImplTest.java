...
public class TestServiceImplTest {
    ...
    public void initTestService() {
        testService = new TestServiceImpl(ioService, questionDao, validationService);
    }
    ...
    public void successfulPrintsTest() {
        ...
        Mockito.when(validationService.validateInput(3, null))
                        .thenReturn(new InputtedAnswerValidationResult(true, 1, null));
